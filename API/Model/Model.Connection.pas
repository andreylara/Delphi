...
uses
  ...
  FireDAC.Phys.MSSQL, FireDAC.Phys.FBDef, System.Classes,
...
begin
  try
    try
      ...
      FConn.Params.Values['DriverID'] := ini.ReadString('Banco de Dados',
        'DriverID', '');
      FConn.Params.Values['Database'] := ini.ReadString('Banco de Dados',
        'Database', '');
      FConn.Params.Values['User_name'] := ini.ReadString('Banco de Dados',
        'User_name', '');
      FConn.Params.Values['Password'] := ini.ReadString('Banco de Dados',
        'Password', '');
      FConn.Params.Add('Port=' + ini.ReadString('Banco de Dados',
        'Port', '3050'));
